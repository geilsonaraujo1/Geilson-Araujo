...
public class tela_cadastral_edicao extends javax.swing.JFrame {
    ...
    public tela_cadastral_edicao(Modelmotorista motorista) {
        initComponents();
        aux = true;
        this.cliente = motorista;

        jTextField1.setText(cliente.getNome());
        jTextField2.setText(cliente.getCpf());
        jTextField3.setText(cliente.getCarro());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        controller.Controllermotorista controle = new Controllermotorista();
...
//        System.out.println(cliente.getId());
        if (!aux){
            ...
            controle.atualizarmotoristaController(cliente);
        }        
        this.dispose();
